                    ...
                    <div className="max-w-xl">
                        ...
                        <div className="mt-8 space-y-4">
                            <div className="glass-card panel-outline rounded-[1.75rem] p-5">
                                <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">Role-based Access</p>
                                <p className="mt-2 text-2xl font-bold text-slate-900 dark:text-white">Sponsor, NGO, Volunteer, Guardian</p>
                            </div>
                            <div className="glass-card panel-outline rounded-[1.75rem] p-5">
                                <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">No UX-only regressions</p>
                                <p className="mt-2 text-2xl font-bold text-slate-900 dark:text-white">Same backend flow</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                className="field-input pr-10 dark:bg-slate-900/70 dark:text-white"
                                value={role}
